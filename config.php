...
if(isset($_POST['job'])){
 $cname=$_POST['cname'];
	 ...
	 $CTC=$_POST['CTC'];
              ...
              $sql="INSERT INTO `jobs`(`id`,`cname`,`position`,`Jdesc`,`CTC`) VALUES('$cname','$pos','$Jdesc','$skills','$CTC')";
...
if(isset($_POST['submit'])){
    ...
    $sql="INSERT INTO `jobs`(`name`,`apply`,`qual`,`year`) VALUES('$name','$apply','$qual','$year')";
    var_dump($sql);
    die();
